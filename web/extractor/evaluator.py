...
def matlab(d):
    ...
    if not d:
      ...
      data = json.loads(d) 
      res = mlab.run_func('/System/server/web/matlab/evaluator/api_full.m', {'feature': data})
...
def get_score(url):
 ...
 # print 'started'
#  t="http://www.acfun.tv/"
#/System/server/web/extractor/screenshot/www_163_com.png
 # score=get_score('/extractor/screenshot/www_sjtu_edu_cn.png')
